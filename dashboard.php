    ...
    <style>
        ...
        */
        ...
        .dashboard {
            ...
            /* this gives the shiny effect on the right side */
            display: flex;
        ...
        .content {
            flex-grow: 1;
            /* this part helps to push the logout button to the bottom */
            font-family: 'Plus Jakarta Sans', sans-serif;
            color: #000000;
        }
    ...
    <div class="dashboard">
        ...
        <div class="content">
            ...
            <form class="searchBar" method="POST" action="searchBar.php">
                <input type="text" name="userInput" class="searchInput" placeholder="Search for songs, albums..."
                    required>
